(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-gapi', ['exports', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ng-gapi'] = {}, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    exports.GoogleApiService = /** @class */ (function () {
        ...
        GoogleApiService.prototype.loadGapi = function () {
            ...
            return new rxjs.Observable(function (observer) {
                if (_this.gapiLoaded) {
                     ...
                     */
                    _this.node = document.createElement('script');
                    _this.node.async = true;
                    _this.node.src = _this.gapiUrl;
                    _this.node.type = 'text/javascript';
                    _this.node.onload = function () {
                        _this.gapiLoaded = true;
                        while (_this.observers.length) {
                            var observer_1 = _this.observers.shift();
                            observer_1.next(true);
                            observer_1.complete();
                        }
                        _this.node = undefined;
                    };
                    _this.node.onerror = function () {
                        _this.node = undefined;
                    };
                    document.getElementsByTagName('head')[0].appendChild(_this.node);
                }
                else {
                    /**
    ...
    exports.GoogleApiService = __decorate([
        core.Injectable(),
        __param(0, core.Inject(NG_GAPI_CONFIG))
    ], exports.GoogleApiService);

    exports.GoogleAuthService = /** @class */ (function () {
        ...
        GoogleAuthService.prototype.getAuth = function (newInstance) {
            ...
            if (!this.GoogleAuth || newInstance) {
                return this.googleApi.onLoad()
                    .pipe(operators.mergeMap(function () { return _this.loadGapiAuth(); }));
            }
    ...
    exports.GoogleAuthService = __decorate([
        core.Injectable(),
        __param(0, core.Inject(exports.GoogleApiService))
    ], exports.GoogleAuthService);

    var GoogleApiModule_1;
    exports.GoogleApiModule = GoogleApiModule_1 = /** @class */ (function () {
        function GoogleApiModule() {
        }
        GoogleApiModule.forRoot = function (gapiConfigProvider) {
            return {
    ...
    exports.GoogleApiModule = GoogleApiModule_1 = __decorate([
        core.NgModule()
...
//# sourceMappingURL=ng-gapi.umd.js.map
